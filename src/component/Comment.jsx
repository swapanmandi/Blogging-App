...
await axios.post(`${import.meta.env.VITE_BACKEND_API}/api/post/comment/${postId}`, {content: comment},{
...
setComment("")
 ...
 useEffect(() =>{
  const handleGetComments = async() =>{
    const result = await axios.get(`${import.meta.env.VITE_BACKEND_API}/api/post/comments/${postId}`,{
