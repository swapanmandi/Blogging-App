...
await axios.post(`${import.meta.env.VITE_BACKEND_API}/api/v1/blog/post/comment/${postId}`, {content: comment},{
...
setComment("")
 ...
 useEffect(() =>{
  const handleGetComments = async() =>{
    const result = await axios.get(`${import.meta.env.VITE_BACKEND_API}/api/v1/blog/post/comments/${postId}`,{
